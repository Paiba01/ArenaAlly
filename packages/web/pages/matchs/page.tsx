...
export const Matchs = () => {
  ...
  const filteredMatches = useMemo(() => {
    ...
    return data.filter(match => {
      ...
      const matchesTeam1 = !appliedTeam1Filter || 
        localTeam.includes(team1Match) || 
        visitorTeam.includes(team1Match)

      const matchesTeam2 = !appliedTeam2Filter || 
        localTeam.includes(team2Match) || 
        visitorTeam.includes(team2Match)

      const matchesDate = isDateInRange(match.day, appliedDateFrom, appliedDateTo)

      return matchesTeam1 && matchesTeam2 && matchesDate
    })
  }, [data, appliedTeam1Filter, appliedTeam2Filter, appliedDateFrom, appliedDateTo])
    ...
    <MainContainer>
      ...
      <PageContainer>
        ...
        {filteredMatches.length > 0 ? (
          ...
          <NotFound>No se encontraron resultados para los filtros aplicados</NotFound>
        )}
      </PageContainer>
    </MainContainer>
  )
